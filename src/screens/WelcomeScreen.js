        ...
        <View className='flex-1 flex justify-end'>
            ...
            <View className='p-5 pb-10 space-y-8'>
                ...
                <View className='space-y-3'>
                    <Text className='text-white font-bold text-5xl' style={{ fontSize: wp(10) }}>Travelling made easy</Text>
                ...
                <TouchableOpacity onPress={() => navigation.navigate("Home")} className='bg-orange-500 mx-auto p-3 px-12 rounded-full'>
                    <Text className='text-white font-bold text-lg' style={{ fontSize: wp(5.5) }}>Let's go!</Text>
                </TouchableOpacity>
            </View>
