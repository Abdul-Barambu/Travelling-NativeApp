...
const DestinationCard = ({ item, navigation }) => {
    ...
    return (
        <TouchableOpacity onPress={() => navigation.navigate('Destination', { ...item })} style={{ width: wp(44), height: wp(65) }} className='flex justify-end relative p-4 py-6 space-y-2 mb-3'>
            <Image source={item.image} style={{ width: wp(44), height: wp(65), borderRadius: 35 }}
                className='absolute' />
            ...
            <TouchableOpacity onPress={() => toggleFavorite(!favorite)} style={{ backgroundColor: 'rgba(255,255,255,0.4)' }} className='absolute top-1 right-3 rounded-full p-3'>
